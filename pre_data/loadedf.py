...
def loaddata():
    ...
    # 构建数据目录的绝对路径
    data_dir = os.path.join(script_dir, '..', 'data_edf_20_npz', 'fpzcz')
...
def loaddata2d():
    ...
    # 构建数据目录的绝对路径
    data_dir = os.path.join(script_dir, '..', 'data_edf_20_npz', 'cwt_results')
    file_names = [f for f in os.listdir(data_dir) if f.endswith('.npz')]  # 获取所有的 .npz 文件
...
def loaddata_2():
    ...
    # 构建数据目录的绝对路径
    data_dir = os.path.join(script_dir, '..', 'data_edf_20_npz')
    file_names = [f for f in os.listdir(data_dir) if f.endswith('.npy')]  # 获取所有的 .npz 文件
